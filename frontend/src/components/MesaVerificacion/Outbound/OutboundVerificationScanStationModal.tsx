...
export const OutboundVerificationScanStationModal: React.FC<OutboundVerificationScanStationModalProps> = ({
 ...
 Escanea el código QR físico del carril asignado: <strong className="font-mono text-rose-600 text-sm">{order.assignedLane}</strong> ({order.warehouseName}).
 </p>
 </div>
 ...
 <strong className="text-2xl font-mono font-black text-rose-600">
 {validatedCount}
 </strong>
 ...
 <div className="w-14 h-14 rounded-2xl border border-dashed border-rose-500/40 flex items-center justify-center">
 ...
 className="py-3 px-4 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-black text-xs transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
 >
 <Scan className="w-4 h-4" />
 ...
 <strong className="font-mono text-rose-600 text-xs">{order.folio}</strong>
 </div>
 <div>
