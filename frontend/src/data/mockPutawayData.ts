...
export const INITIAL_PUTAWAY_ORDERS: PutawayOrder[] = [
  ...
  // 2. CEDIS Norte - Pendiente (Consolidación de SKU & FIFO)
  {
    ...
    items: [
      ...
      { id: 'oai-4-3', uid: 'TAR-RTM-2026-000199', sku: 'FLX-BOP-001', productName: 'Película BOPP Transparente 35 micras Avery', brand: 'Schneider Electric', size: 'Bobina 1,500 m', lotNumber: 'LOTE-2026-W35', sourceLocation: 'REC-01', targetLocation: 'B-B-01', suggestedLocation: 'B-B-01', status: 'Pendiente' },
    ],
  },
  ...
  // 4. CEDIS Norte - Completa (Retrabajo de unidad dañada + Acomodo final)
  {
    ...
    items: [
      { id: 'oai-6-1', uid: 'TAR-RTM-2026-000141', sku: 'FLX-BOP-001', productName: 'Película BOPP Transparente 35 micras Avery', brand: 'Schneider Electric', size: 'Bobina 1,500 m', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-01', targetLocation: 'B-A-01', suggestedLocation: 'B-A-01', status: 'Acomodado', completedAt: '26 Ago 14:25', operator: 'Carlos Medina' },
      { id: 'oai-6-2', uid: 'TAR-RTM-2026-000142', sku: 'FLX-BOP-001', productName: 'Película BOPP Transparente 35 micras Avery', brand: 'Schneider Electric', size: 'Bobina 1,500 m', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-01', targetLocation: 'B-A-02', suggestedLocation: 'B-A-02', status: 'Acomodado', completedAt: '26 Ago 14:40', operator: 'Carlos Medina' },
      { id: 'oai-6-3', uid: 'TAR-RTM-2026-000143', sku: 'FLX-BOP-001', productName: 'Película BOPP Transparente 35 micras Avery', brand: 'Schneider Electric', size: 'Bobina 1,500 m', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-01', targetLocation: 'RET-NORTE', suggestedLocation: 'RET-NORTE', status: 'Acomodado', completedAt: '26 Ago 15:30', operator: 'Carlos Medina', notes: 'Unidad enviada a Retrabajo para reetiquetado.' },
    ],
  },
  ...
  // 5. CEDIS Sur - En proceso
  {
    ...
    items: [
      ...
      { id: 'oai-3-3', uid: 'TAR-RTM-2026-000305', sku: 'PT-BLI-001', productName: 'Blister Card Termosellable Stanley Tools', brand: 'Stanley Tools', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W34', sourceLocation: 'REC-02', targetLocation: 'B-A-02', suggestedLocation: 'B-A-02', status: 'Pendiente' },
      { id: 'oai-3-4', uid: 'TAR-RTM-2026-000306', sku: 'PT-BLI-001', productName: 'Blister Card Termosellable Stanley Tools', brand: 'Stanley Tools', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W34', sourceLocation: 'REC-02', targetLocation: 'B-A-03', suggestedLocation: 'B-A-03', status: 'Pendiente' },
    ],
  },
  // 6. CEDIS Sur - Pendiente
  {
    ...
    items: [
      ...
      { id: 'oai-7-2', uid: 'TAR-RTM-2026-000302', sku: 'PT-ETQ-002', productName: 'Etiqueta Farmacéutica 4x6" Medifarma', brand: 'Medifarma', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W35', sourceLocation: 'REC-02', targetLocation: 'A-B-04', suggestedLocation: 'A-B-04', status: 'Pendiente' },
    ],
  },
  // 7. CEDIS Sur - Completa
  {
    ...
    items: [
      { id: 'oai-2-1', uid: 'TAR-RTM-2026-000131', sku: 'PT-BLI-001', productName: 'Blister Card Termosellable Stanley Tools', brand: 'Stanley Tools', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-02', targetLocation: 'B-A-01', suggestedLocation: 'B-A-01', status: 'Acomodado', completedAt: '26 Ago 15:35', operator: 'Valeria Torres' },
      { id: 'oai-2-2', uid: 'TAR-RTM-2026-000132', sku: 'PT-BLI-001', productName: 'Blister Card Termosellable Stanley Tools', brand: 'Stanley Tools', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-02', targetLocation: 'B-A-02', suggestedLocation: 'B-A-02', status: 'Acomodado', completedAt: '26 Ago 15:45', operator: 'Valeria Torres' },
      { id: 'oai-2-3', uid: 'TAR-RTM-2026-000133', sku: 'PT-BLI-001', productName: 'Blister Card Termosellable Stanley Tools', brand: 'Stanley Tools', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-02', targetLocation: 'B-B-01', suggestedLocation: 'B-B-01', status: 'Acomodado', completedAt: '26 Ago 16:05', operator: 'Valeria Torres' },
      { id: 'oai-2-4', uid: 'TAR-RTM-2026-000134', sku: 'PT-BLI-001', productName: 'Blister Card Termosellable Stanley Tools', brand: 'Stanley Tools', size: 'Tarima 10,000 pzas', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-02', targetLocation: 'B-B-02', suggestedLocation: 'B-B-02', status: 'Acomodado', completedAt: '26 Ago 16:20', operator: 'Valeria Torres' },
    ],
  },
  ...
  // 8. Almacén Auxiliar Reynosa - Parcial (Envío a Área de Muestras + Almacén)
  {
    ...
    completedUnits: 1,
    pendingUnits: 2,
    notes: 'Acomodo de unidades traspasadas: 1 a bahía de Inspección QA STG-02 y 2 a bodega local BOD-REY-01.',
    items: [
  ...
  // 9. Almacén Auxiliar Reynosa - Completa
  {
    ...
    items: [
      { id: 'oai-9-1', uid: 'TAR-RTM-2026-000151', sku: 'PT-ETQ-001', productName: 'Etiqueta Farmacéutica 4x6" Medifarma', brand: 'Medifarma', size: 'Individual', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-REY-AUX', targetLocation: 'QA-01', suggestedLocation: 'QA-01', status: 'Acomodado', completedAt: '25 Ago 12:30', operator: 'Brenda Cavazos' },
      { id: 'oai-9-2', uid: 'TAR-RTM-2026-000152', sku: 'PT-ETQ-001', productName: 'Etiqueta Farmacéutica 4x6" Medifarma', brand: 'Medifarma', size: 'Individual', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-REY-AUX', targetLocation: 'BOD-REY-01', suggestedLocation: 'BOD-REY-01', status: 'Acomodado', completedAt: '25 Ago 13:00', operator: 'Brenda Cavazos' },
    ],
  },
  ...
  // 10. Almacén Satélite Matamoros - En proceso
  {
    ...
    operatorAssigned: 'Jorge Villarreal (Encargado Almacén)',
    status: 'En proceso',
    totalUnits: 2,
    completedUnits: 1,
    pendingUnits: 1,
    ...
    items: [
      { id: 'oai-10-1', uid: 'TAR-RTM-2026-000191', sku: 'PT-ETQ-001', productName: 'Etiqueta Farmacéutica 4x6" Medifarma', brand: 'Medifarma', size: 'Individual', lotNumber: 'LOTE-2026-W34', sourceLocation: 'REC-MAT', targetLocation: 'SHOW-03', suggestedLocation: 'SHOW-03', status: 'Acomodado', completedAt: '27 Ago 13:20', operator: 'Jorge Villarreal', notes: 'Colocado en bahía SHOW-03.' },
      { id: 'oai-10-2', uid: 'TAR-RTM-2026-000192', sku: 'PT-ETQ-001', productName: 'Etiqueta Farmacéutica 4x6" Medifarma', brand: 'Medifarma', size: 'Individual', lotNumber: 'LOTE-2026-W34', sourceLocation: 'REC-MAT', targetLocation: 'BOD-MAT-01', suggestedLocation: 'BOD-MAT-01', status: 'Pendiente' },
    ],
  },
];
