...
export const INITIAL_MOCK_SHIPPING_ORDERS: ShippingOutboundOrder[] = [
  ...
  // =========================================================================
  {
    ...
    originCoordinates: { x: 260, y: 70, name: 'CEDIS Monterrey Norte' },
    ...
    items: [
      {
        ...
        uids: ['SC-UID-2026-000131', 'SC-UID-2026-000132', 'SC-UID-2026-000133', 'SC-UID-2026-000134'],
      },
      {
        ...
        uids: ['SC-UID-2026-000101', 'SC-UID-2026-000102', 'SC-UID-2026-000103'],
      },
      {
        sku: 'SC-SPA-REC-KS',
        ...
        uids: ['SC-UID-2026-000241', 'SC-UID-2026-000242', 'SC-UID-2026-000243', 'SC-UID-2026-000244', 'SC-UID-2026-000245', 'SC-UID-2026-000246', 'SC-UID-2026-000247'],
      },
    ],
    stops: [
      {
    ...
    items: [
      {
        ...
        quantity: 4,
        lotNumber: 'LOTE-2026-W31',
        uids: ['SC-UID-2026-000103', 'SC-UID-2026-000104', 'SC-UID-2026-000105', 'SC-UID-2026-000106'],
      },
      {
        ...
        quantity: 4,
        lotNumber: 'LOTE-2026-W34',
        uids: ['SC-UID-2026-000186', 'SC-UID-2026-000187', 'SC-UID-2026-000188', 'SC-UID-2026-000189'],
      },
    ],
    stops: [
      {
        ...
        items: [
          {
            ...
            size: 'Individual',
            quantity: 3,
            uids: ['SC-UID-2026-000103', 'SC-UID-2026-000104', 'SC-UID-2026-000105'],
          },
          {
            sku: 'SC-NAYT-FLOW-MAT',
            productName: 'Nayt Colchón Flow Basic White Matrimonial',
            ...
            size: 'Matrimonial',
            quantity: 2,
            uids: ['SC-UID-2026-000186', 'SC-UID-2026-000187'],
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            size: 'Matrimonial',
            quantity: 2,
            uids: ['SC-UID-2026-000188', 'SC-UID-2026-000189'],
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        quantity: 3,
        lotNumber: 'LOTE-2026-W34',
        uids: ['SC-UID-2026-000261', 'SC-UID-2026-000262', 'SC-UID-2026-000263'],
      },
      {
        sku: 'SC-REST-ORTO-KS',
        ...
        quantity: 3,
        lotNumber: 'LOTE-2026-W34',
        uids: ['SC-UID-2026-000246', 'SC-UID-2026-000247', 'SC-UID-2026-000248'],
      },
    ],
    stops: [
      {
    ...
    routeAlternatives: [
      {
        ...
        description: 'Trayecto punto a punto directo desde CEDIS Monterrey Norte hacia San Pedro Garza García vía Túnel de la Loma Larga.',
      },
    ],
  },
  ...
  // =========================================================================
  {
    ...
    originCoordinates: { x: 580, y: 410, name: 'CEDIS Monterrey Sur' },
    destinationName: 'Roberto Cantú Garza',
    ...
    items: [
      ...
      },
      {
        ...
        quantity: 2,
        lotNumber: 'LOTE-2026-W33',
        uids: ['SC-UID-2026-000138', 'SC-UID-2026-000139'],
      },
    ],
    stops: [
      {
  ...
  // =========================================================================
  // 5. TRASPASO DIRECTO (CEDIS Norte -> Sucursal Valle Oriente · 14 Unidades)
  // =========================================================================
  {
    id: 'sh-ord-3',
    folio: 'OS-2026-0049',
    ...
    items: [
      {
        ...
        quantity: 4,
        lotNumber: 'LOTE-2026-W33',
        uids: ['SC-UID-2026-000151', 'SC-UID-2026-000152', 'SC-UID-2026-000153', 'SC-UID-2026-000154'],
      },
      {
        sku: 'SC-NAYT-FLOW-IND',
        productName: 'Nayt Colchón Flow Basic White Individual',
        ...
        quantity: 6,
        lotNumber: 'LOTE-2026-W31',
        uids: ['SC-UID-2026-000101', 'SC-UID-2026-000102', 'SC-UID-2026-000107', 'SC-UID-2026-000108', 'SC-UID-2026-000109', 'SC-UID-2026-000110'],
      },
      {
        sku: 'SC-REST-ORTO-MAT',
        productName: 'Restonic Colchón Ortopedic Matrimonial',
        ...
        quantity: 4,
        lotNumber: 'LOTE-2026-W33',
        uids: ['SC-UID-2026-000211', 'SC-UID-2026-000212', 'SC-UID-2026-000213', 'SC-UID-2026-000214'],
      },
    ],
    stops: [
      {
  ...
  // =========================================================================
  // 6. TRASPASO DIRECTO (CEDIS Sur -> Sucursal Cumbres · 9 Unidades)
  // =========================================================================
  {
    id: 'sh-ord-4',
    folio: 'OS-2026-0051',
    ...
    items: [
      {
        ...
        quantity: 5,
        lotNumber: 'LOTE-2026-W33',
        uids: ['SC-UID-2026-000135', 'SC-UID-2026-000136', 'SC-UID-2026-000215', 'SC-UID-2026-000216', 'SC-UID-2026-000217'],
      },
      {
        sku: 'SC-SEA-CLB-KS',
        ...
        uids: ['SC-UID-2026-000301', 'SC-UID-2026-000302', 'SC-UID-2026-000303', 'SC-UID-2026-000304'],
      },
    ],
    stops: [
      {
    ...
    routeAlternatives: [
      {
        ...
        description: 'Recorrido directo conectando CEDIS Monterrey Sur con Sucursal Cumbres vía Av. Gonzalitos y Av. Paseo de los Leones.',
      },
    ],
  },
  // =========================================================================
  ...
  // =========================================================================
  {
    ...
    originWarehouseName: 'Sucursal Valle Oriente',
    originCoordinates: { x: 440, y: 340, name: 'Sucursal Valle Oriente' },
    ...
    items: [
      {
        ...
        uids: ['SC-UID-2026-000301', 'SC-UID-2026-000302'],
      },
      {
        sku: 'SC-NAYT-FLOW-MAT',
        productName: 'Nayt Colchón Flow Basic White Matrimonial',
    ...
    loadingZones: [
      {
        ...
        totalUnits: 2,
        items: [],
        uids: ['SC-UID-2026-000321', 'SC-UID-2026-000322'],
      },
      {
        id: 'lz-55-3',
        zoneCode: 'ZONA B',
        ...
        totalUnits: 2,
        items: [],
        uids: ['SC-UID-2026-000319', 'SC-UID-2026-000320'],
      },
      {
        id: 'lz-55-2',
        zoneCode: 'ZONA C',
        ...
        totalUnits: 2,
        items: [],
        uids: ['SC-UID-2026-000317', 'SC-UID-2026-000318'],
      },
      {
        id: 'lz-55-1',
        zoneCode: 'ZONA D',
        ...
        totalUnits: 3,
        items: [],
        uids: ['SC-UID-2026-000314', 'SC-UID-2026-000315', 'SC-UID-2026-000316'],
      },
    ],
    stops: [
      {
      ...
      },
      {
        ...
        priority: 'Alta',
        status: 'En atención',
        statusNotes: 'Unidad descargando colchones en departamento muestra.',
        items: [
          {
            sku: 'SC-REST-ORTO-MAT',
            productName: 'Restonic Colchón Ortopedic Matrimonial',
    ...
    loadingZones: [
      {
        ...
        totalUnits: 14,
        items: [],
        uids: ['SC-UID-2026-000151', 'SC-UID-2026-000152', 'SC-UID-2026-000153', 'SC-UID-2026-000154', 'SC-UID-2026-000101', 'SC-UID-2026-000102', 'SC-UID-2026-000107', 'SC-UID-2026-000108', 'SC-UID-2026-000109', 'SC-UID-2026-000110', 'SC-UID-2026-000211', 'SC-UID-2026-000212', 'SC-UID-2026-000213', 'SC-UID-2026-000214'],
      },
    ],
    stops: [
      {
    ...
    loadingZones: [
      {
        ...
        totalUnits: 9,
        items: [],
        uids: ['SC-UID-2026-000135', 'SC-UID-2026-000136', 'SC-UID-2026-000215', 'SC-UID-2026-000216', 'SC-UID-2026-000217', 'SC-UID-2026-000301', 'SC-UID-2026-000302', 'SC-UID-2026-000303', 'SC-UID-2026-000304'],
      },
    ],
    stops: [
      {
        ...
        arrivalRecord: {
          ...
          coordinates: { lat: 25.7145, lng: -100.3872, label: '25.7145, -100.3872 (Sucursal Cumbres)' },
          driverName: 'Raúl Morales',
    ...
    loadingZones: [
      {
        ...
        totalUnits: 6,
        items: [],
        uids: ['SC-UID-2026-000261', 'SC-UID-2026-000262', 'SC-UID-2026-000263', 'SC-UID-2026-000246', 'SC-UID-2026-000247', 'SC-UID-2026-000248'],
      },
    ],
    stops: [
      {
    ...
    loadingZones: [
      {
        ...
        totalUnits: 3,
        items: [],
        uids: ['SC-UID-2026-000137', 'SC-UID-2026-000138', 'SC-UID-2026-000139'],
      },
    ],
    stops: [
      {
    ...
    loadingZones: [
      {
        ...
        totalUnits: 6,
        items: [],
        uids: ['SC-UID-2026-000305', 'SC-UID-2026-000306'],
      },
      {
        id: 'lz-56-1',
        zoneCode: 'ZONA B',
        ...
        totalUnits: 6,
        items: [],
        uids: ['SC-UID-2026-000307', 'SC-UID-2026-000308'],
      },
    ],
    stops: [
      {
    ...
    loadingZones: [
      {
        ...
        totalUnits: 10,
        items: [],
        uids: ['SC-UID-2026-000351', 'SC-UID-2026-000352'],
      },
    ],
    stops: [
      {
        ...
        arrivalRecord: {
          ...
          coordinates: { lat: 25.6480, lng: -100.3270, label: '25.6480, -100.3270 (Sucursal Valle Oriente)' },
          driverName: 'Javier Salinas',
...
export const INITIAL_MOCK_SHIPPING_HISTORY: ShippingHistoryRecord[] = [
    ...
    stops: [
      {
        ...
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 2, uids: ['SC-UID-2026-000101', 'SC-UID-2026-000102'] },
          { sku: 'SC-REST-ORTO-MAT', productName: 'Restonic Colchón Ortopedic Matrimonial', brand: 'Restonic', size: 'Matrimonial', quantity: 2, uids: ['SC-UID-2026-000107', 'SC-UID-2026-000108'] },
        ],
      },
      {
        stopSequence: 2,
        ...
        items: [
          { sku: 'SC-SEA-POST-QS', productName: 'Sealy Colchón Posturepedic Queen Size', brand: 'Sealy', size: 'Queen Size', quantity: 3, uids: ['SC-UID-2026-000109', 'SC-UID-2026-000110', 'SC-UID-2026-000111'] },
        ],
      },
      {
        stopSequence: 3,
        ...
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 4, uids: ['SC-UID-2026-000112', 'SC-UID-2026-000113', 'SC-UID-2026-000114', 'SC-UID-2026-000115'] },
          { sku: 'SC-AMER-CONF-IND', productName: 'America Colchón Confort Individual', brand: 'America', size: 'Individual', quantity: 3, uids: ['SC-UID-2026-000116', 'SC-UID-2026-000117', 'SC-UID-2026-000118'] },
        ],
      },
    ],
    timeline: [
    ...
    stops: [
      {
        ...
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 3, uids: ['SC-UID-2026-000121', 'SC-UID-2026-000122', 'SC-UID-2026-000123'] },
          { sku: 'SC-REST-ORTO-KS', productName: 'Restonic Colchón Ortopedic King Size', brand: 'Restonic', size: 'King Size', quantity: 3, uids: ['SC-UID-2026-000124', 'SC-UID-2026-000125', 'SC-UID-2026-000126'] },
        ],
      },
    ],
    timeline: [
    ...
    stops: [
      {
        ...
        incidentNotes: 'Se entregaron 3 de 4 colchones. Faltó 1 pieza SKU SC-AMER-CONF-IND (SC-UID-2026-000084). Pendiente reenvío en ruta vespertina.',
        items: [
          { sku: 'SC-SPA-REC-MAT', productName: 'Spring Air Colchón Record Matrimonial', brand: 'Spring Air', size: 'Matrimonial', quantity: 2, uids: ['SC-UID-2026-000081', 'SC-UID-2026-000082'] },
          { sku: 'SC-AMER-CONF-IND', productName: 'America Colchón Confort Individual', brand: 'America', size: 'Individual', quantity: 1, uids: ['SC-UID-2026-000083'] },
        ],
      },
    ],
    timeline: [
    ...
    stops: [
      {
        ...
        incidentNotes: 'Cliente aceptó 5 colchones y rechazó 1 pieza (SC-UID-2026-000095) por plástico protector rasgado durante la maniobra.',
        items: [
          { sku: 'SC-SEA-POST-QS', productName: 'Sealy Colchón Posturepedic Queen Size', brand: 'Sealy', size: 'Queen Size', quantity: 5, uids: ['SC-UID-2026-000091', 'SC-UID-2026-000092', 'SC-UID-2026-000093', 'SC-UID-2026-000094', 'SC-UID-2026-000096'] },
        ],
      },
    ],
    timeline: [
    ...
    stops: [
      {
        ...
        incidentNotes: 'El cliente recibió las 3 piezas pero firmó bajo reserva por leve raspadura en esquina inferior del colchón SC-UID-2026-000072.',
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 3, uids: ['SC-UID-2026-000071', 'SC-UID-2026-000072', 'SC-UID-2026-000073'] },
        ],
      },
    ],
    timeline: [
    ...
    stops: [
      {
        ...
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 2, uids: ['SC-UID-2026-000076', 'SC-UID-2026-000077'] },
        ],
      },
    ],
    timeline: [
  ...
  // =========================================================================
  {
    ...
    sourceDocumentType: 'OTP',
    destinationSummary: 'Sucursal Valle Oriente',
    vehicleId: 'veh-12',
    vehicleName: 'Camión #12 · Hino 300',
    driverId: 'drv-2',
    driverName: 'Carlos Medina',
    ...
    stops: [
      {
        ...
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 6, uids: ['SC-UID-2026-000051', 'SC-UID-2026-000052', 'SC-UID-2026-000053', 'SC-UID-2026-000054', 'SC-UID-2026-000055', 'SC-UID-2026-000056'] },
          { sku: 'SC-REST-ORTO-MAT', productName: 'Restonic Colchón Ortopedic Matrimonial', brand: 'Restonic', size: 'Matrimonial', quantity: 8, uids: ['SC-UID-2026-000061', 'SC-UID-2026-000062', 'SC-UID-2026-000063', 'SC-UID-2026-000064', 'SC-UID-2026-000065', 'SC-UID-2026-000066', 'SC-UID-2026-000067', 'SC-UID-2026-000068'] },
        ],
      },
    ],
    timeline: [
      ...
      { stepName: 'Llegada a andén de Sucursal Valle Oriente', timestamp: '28 Ago 2026 · 09:05', responsibleUser: 'Carlos Medina', referenceFolio: 'REM-TR-2026-0019' },
  ...
  // =========================================================================
  // 8. TRASPASO ENTREGADO FÍSICAMENTE (Sucursal Cumbres · Pendiente Recepción)
  // =========================================================================
  {
    id: 'hist-rt-0030',
    ...
    sourceDocumentType: 'OTP',
    destinationSummary: 'Sucursal Cumbres',
    vehicleId: 'veh-05',
    vehicleName: 'Camión #05 · Isuzu Forward',
    driverId: 'drv-5',
    driverName: 'Raúl Morales',
    ...
    stops: [
      {
        ...
        branchReceiptConfirmed: false,
        items: [
          { sku: 'SC-SPA-REC-MAT', productName: 'Spring Air Colchón Record Matrimonial', brand: 'Spring Air', size: 'Matrimonial', quantity: 5, uids: ['SC-UID-2026-000041', 'SC-UID-2026-000042', 'SC-UID-2026-000043', 'SC-UID-2026-000044', 'SC-UID-2026-000045'] },
          { sku: 'SC-SEA-POST-QS', productName: 'Sealy Colchón Posturepedic Queen Size', brand: 'Sealy', size: 'Queen Size', quantity: 4, uids: ['SC-UID-2026-000046', 'SC-UID-2026-000047', 'SC-UID-2026-000048', 'SC-UID-2026-000049'] },
        ],
      },
    ],
    timeline: [
      { stepName: 'Salida de CEDIS Sur', timestamp: '28 Ago 2026 · 09:30', responsibleUser: 'Raúl Morales', referenceFolio: 'RT-2026-0030' },
      { stepName: 'Llegada a Sucursal Cumbres', timestamp: '28 Ago 2026 · 10:12', responsibleUser: 'Raúl Morales', referenceFolio: 'REM-TR-2026-0020' },
    ...
    stops: [
      {
        ...
        items: [
          { sku: 'SC-SPA-REC-KS', productName: 'Spring Air Colchón Record King Size', brand: 'Spring Air', size: 'King Size', quantity: 6, uids: ['SC-UID-2026-000031', 'SC-UID-2026-000032', 'SC-UID-2026-000033', 'SC-UID-2026-000034', 'SC-UID-2026-000035', 'SC-UID-2026-000036'] },
          { sku: 'SC-REST-ORTO-MAT', productName: 'Restonic Colchón Ortopedic Matrimonial', brand: 'Restonic', size: 'Matrimonial', quantity: 6, uids: ['SC-UID-2026-000037', 'SC-UID-2026-000038', 'SC-UID-2026-000039', 'SC-UID-2026-000040', 'SC-UID-2026-000021', 'SC-UID-2026-000022'] },
        ],
      },
    ],
    timeline: [
      ...
      { stepName: 'Recepción y validación 100% en Mesa de Verificación', timestamp: '25 Ago 2026 · 11:35', responsibleUser: 'Brenda Cavazos (MdeV)', referenceFolio: 'ENT-2026-0018', notes: '12 UIDs escaneadas e ingresadas a inventario de Sucursal Valle Oriente.' },
    ],
  },
    ...
    stops: [
      {
        ...
        items: [
          { sku: 'SC-SPA-REC-MAT', productName: 'Spring Air Colchón Record Matrimonial', brand: 'Spring Air', size: 'Matrimonial', quantity: 4, uids: ['SC-UID-2026-000011', 'SC-UID-2026-000012', 'SC-UID-2026-000013', 'SC-UID-2026-000014'] },
          { sku: 'SC-REST-ORTO-MAT', productName: 'Restonic Colchón Ortopedic Matrimonial', brand: 'Restonic', size: 'Matrimonial', quantity: 4, uids: ['SC-UID-2026-000015', 'SC-UID-2026-000016', 'SC-UID-2026-000017', 'SC-UID-2026-000018'] },
        ],
      },
    ],
    timeline: [
      ...
      { stepName: 'Recepción confirmada en Mesa de Verificación', timestamp: '26 Ago 2026 · 15:30', responsibleUser: 'Jorge Villarreal (MdeV)', referenceFolio: 'ENT-2026-0021', notes: '8 UIDs verificadas e ingresadas a inventario disponible de Sucursal Cumbres.' },
    ],
  },
...
export const INITIAL_MOCK_FLEET: FleetVehicleItem[] = [
  {
    ...
    facilityName: 'CEDIS Monterrey Norte',
  ...
  },
  {
    ...
    facilityName: 'CEDIS Monterrey Sur',
    lastActivityText: 'En ruta · Arribo en Sucursal Cumbres',
  },
  {
    id: 'veh-05',
    vehicleName: 'Camión #05 · Isuzu Forward',
