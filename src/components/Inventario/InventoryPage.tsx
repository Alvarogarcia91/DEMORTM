...
export const InventoryPage: React.FC = () => {
 ...
 { id: 'transfers', label: 'Traspasos', icon: ArrowLeftRight },
 { id: 'counts', label: 'Conteos', icon: ClipboardCheck },
 { id: 'warehouses', label: 'Almacenes & Sucursales', icon: Building2 },
 ];
 ...
 Control físico, trazabilidad de existencias por CEDIS y analítica de operaciones.
 </p>
 </div>
 </div>
