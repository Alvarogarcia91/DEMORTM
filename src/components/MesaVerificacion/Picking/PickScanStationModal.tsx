...
export const PickScanStationModal: React.FC<PickScanStationModalProps> = ({
 ...
 <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-white text-zinc-900 border border-theme-primary shadow-2xs font-mono">
 Parada #{currentStop.sequence}
 </span>
 <span className="font-mono text-xs font-black text-theme-primary">{currentStop.uid}</span>
 ...
 <strong className="text-theme-primary text-sm">{currentStop.locationCode}</strong>
 </div>
 ...
 Dirígete al rack y escanea el código QR de la posición: <strong className="font-mono text-theme-primary text-sm">{currentStop.locationCode}</strong> ({currentStop.aisle} &bull; {currentStop.rackPosition} &bull; {currentStop.level}).
 </p>
 </div>
 ...
 <strong className="font-mono text-theme-primary text-xs">{activePickedUid}</strong>
 {activeSubReason && (
