      ...
      prev.map(b => {
        if (b.id === bayId) {
          return {
            ...
            currentArticle: {
              sku,
              productName: sku.includes('RTM Impresos') ? 'RTM Impresos Muestrario Flow Basic White Individual' : 'RTM Offset Muestrario Moon Cool Queen Size',
              brand: sku.includes('RTM Impresos') ? 'RTM Impresos' : 'RTM Offset',
              size: sku.includes('IND') ? 'Individual' : 'Queen Size',
              category: 'Muestrarioes',
              priceMxn: 7499,
              rotationTier: 'Alta',
            },
            currentUnit: {
            ...
            history: [
              {
                ...
                uid,
                sku,
                productName: 'RTM Impresos Muestrario Flow Basic White Individual',
