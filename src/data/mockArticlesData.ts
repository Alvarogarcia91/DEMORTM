...
const createIndustrialArticle = (data: {
  ...
  return {
    id: data.id,
    sku: data.sku,
    partNumber: data.partNumber || data.sku,
    name: data.name,
    brand: data.brand,
    customer: data.customer || (data.category === 'Producto Terminado' ? data.brand : undefined),
    revision: data.revision,
    technology: data.technology,
    mainMaterial: data.mainMaterial || (data.technology === 'Offset' ? 'Papel Bond / Couché' : 'Película Sintética'),
...
export const MOCK_MASTER_ARTICLES: MasterArticle[] = [
  createIndustrialArticle({
    ...
    sku: 'NA472050',
    partNumber: 'NA472050',
    name: 'Manual Cordless Recip Saw DCS382 NA',
    brand: 'BLACK & DECKER',
    customer: 'BLACK & DECKER',
    category: 'Producto Terminado',
    size: '24 páginas (14x21.5 cm)',
    baseUnit: 'pza',
    technology: 'Offset',
    mainMaterial: 'BOND_75_B17',
    revision: 'Rev 08/23',
    specificationSummary: 'Papel Bond 75g (BOND_75), 1 tinta negra, doblado y grapa al lomo',
    classCode: 'PT',
  ...
  createIndustrialArticle({
    ...
    baseUnit: 'pza',
    technology: 'Offset',
    mainMaterial: 'BOND_75_B4 / COUCHE_100',
    revision: 'Rev 09/24',
    specificationSummary: 'Interiores Bond 75g (BOND_75) + Portada Couché 100g (COUCHE_100) a color',
    classCode: 'PT',
    className: 'Producto Terminado',
    groupCode: 'PT-MAN',
    groupName: 'Manuales e Instructivos',
  ...
  createIndustrialArticle({
    ...
    sku: '1641301',
    partNumber: '1641301',
    name: 'User Guide POWERFORCE HELIX',
    brand: 'BISSELL',
    customer: 'BISSELL INTERNATIONAL TRADING COMPANY B.V.',
    category: 'Producto Terminado',
    size: '16 páginas (14x21.5 cm)',
    baseUnit: 'pza',
    technology: 'Offset',
    mainMaterial: 'BOND_60_B4',
    revision: 'Rev .02/24',
    specificationSummary: 'Papel Bond 60g (BOND_60_B4), 2 tintas, doblado y grapado',
    classCode: 'PT',
    className: 'Producto Terminado',
    groupCode: 'PT-MAN',
    groupName: 'Manuales e Instructivos',
  ...
  createIndustrialArticle({
    ...
    sku: 'IS-2420',
    partNumber: 'IS-2420',
    name: 'Slide-In Label Wiper Blade',
    brand: 'TRICO',
    customer: 'TRICO TECHNOLOGIES CORPORATION',
    category: 'Producto Terminado',
    size: 'Rollo 4x6" (1,000 etiquetas)',
    baseUnit: 'rollo',
    technology: 'Flexografía',
    mainMaterial: 'FASSON_THERMAL_TRANSFER',
    revision: 'Rev I-01',
    specificationSummary: 'Fasson Thermal Transfer, 4 tintas UV Flexo + barniz sobreimpresión',
    classCode: 'PT',
    className: 'Producto Terminado',
    groupCode: 'PT-ETQ',
  ...
  createIndustrialArticle({
    ...
    name: 'Etiqueta Poliéster Grado Industrial',
    brand: 'ENTAIL',
    customer: 'ENTAIL ENGINE LLC',
    category: 'Producto Terminado',
    size: 'Rollo 2x4" (2,000 etiquetas)',
    baseUnit: 'rollo',
    technology: 'Flexografía',
    mainMaterial: '3M 7850 HL',
    revision: 'Rev A',
    specificationSummary: 'Poliéster 3M 7850 HL autoadherible alta temperatura para ensamble industrial',
    classCode: 'PT',
    className: 'Producto Terminado',
    groupCode: 'PT-ETQ',
    groupName: 'Etiquetas Autoadheribles',
  ...
  createIndustrialArticle({
    ...
    name: 'Instructivo e-Force Seguridad Contra Incendios',
    brand: 'TYCO',
    customer: 'TYCO',
    category: 'Producto Terminado',
    ...
    baseUnit: 'pza',
    technology: 'Offset',
    mainMaterial: 'COUCHE_100_PM2',
    revision: 'Rev B',
    specificationSummary: 'Papel Couché 100g (COUCHE_100), 4 tintas CMYK + Barniz de protección',
    classCode: 'PT',
    className: 'Producto Terminado',
    groupCode: 'PT-MAN',
    groupName: 'Manuales e Instructivos',
  ...
  createIndustrialArticle({
    id: 'art-rtm-07',
    sku: 'BOND-75-B17',
    partNumber: 'BOND-75-B17',
    name: 'Papel Bond 75g Bobina (BOND_75)',
    brand: 'Suministros Gráficos Demo',
    category: 'Sustratos / Papel',
    size: 'Bobina Ancho 17"',
    baseUnit: 'bobina',
    technology: 'Offset',
    mainMaterial: 'BOND_75',
    revision: 'N/A',
    specificationSummary: 'Bobina de papel bond blanco 75 g/m² para prensa rotativa/offset',
    classCode: 'SUS',
    ...
    committed: 4,
    location: 'A-01-04',
    supplier: 'Proveedor de Papeles Gráficos (Demo)',
  }),
  createIndustrialArticle({
    id: 'art-rtm-08',
    sku: '3M-7850-HL',
    partNumber: '3M-7850-HL',
    name: 'Sustrato Poliéster 3M 7850 HL',
    brand: '3M Industrial (Material RTM)',
    category: 'Películas / Flexo',
    size: 'Rollo 10" x 1500m',
    baseUnit: 'rollo',
    technology: 'Flexografía',
    mainMaterial: '3M 7850 HL',
    revision: 'N/A',
    specificationSummary: 'Película sintética poliéster plata mate con adhesivo acrílico 350',
    classCode: 'FLX',
    ...
    committed: 2,
    location: 'B-01-02',
    supplier: 'Distribuidora de Películas Industriales (Demo)',
  }),
  createIndustrialArticle({
    id: 'art-rtm-09',
    sku: 'MP-TIN-CYN',
    partNumber: 'MP-TIN-CYN',
    name: 'Tinta Offset ProPrint Cyan Proceso',
    brand: 'Insumos Químicos Gráficos',
    category: 'Tintas & Barnices',
    size: 'Cubeta 20 Kg',
    baseUnit: 'cubeta',
    technology: 'Offset',
    mainMaterial: 'TINTA_OFFSET_CMYK',
    revision: 'N/A',
    ...
    committed: 5,
    location: 'C-01-01',
    supplier: 'Proveedor de Tintas & Químicos (Demo)',
  }),
  createIndustrialArticle({
    id: 'art-rtm-10',
    sku: 'MP-BAR-UVB',
    partNumber: 'MP-BAR-UVB',
  ...
  createIndustrialArticle({
    id: 'art-rtm-11',
    sku: 'EMP-CAJ-COR',
    partNumber: 'EMP-CAJ-COR',
    name: 'Cajas Corrugadas Flauta C 30x20x25 cm',
    brand: 'Empaques Industriales Demo',
    category: 'Empaque',
    size: 'Paquete 50 pzas',
    baseUnit: 'paquete',
    technology: 'N/A',
    mainMaterial: 'CARTON_CORRUGADO_ECT32',
    revision: 'N/A',
    specificationSummary: 'Cartón corrugado flauta C resistencia ECT 32 para empaque de tarima',
    classCode: 'EMP',
