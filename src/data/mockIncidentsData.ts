...
export const INITIAL_OPERATIONAL_INCIDENTS: OperationalIncident[] = [
  ...
  },
  {
    ...
    locationCode: 'REC-01',
    sku: 'PT-MAN-002',
    productName: 'Manual Instructivo 24 Páginas Black & Decker Queen Size',
    brand: 'Black & Decker',
    size: 'Queen Size',
    lotNumber: 'LOTE-2026-W34',
  ...
  },
  {
    ...
    lotNumber: 'LOTE-2026-W34',
    timeline: [
      { id: 't-56-1', occurredAt: '27 Ago 13:30', actor: 'Jorge Villarreal', role: 'Sucursal', message: 'Bulto con destino Reynosa recibido en Matamoros.', type: 'created' },
    ],
  },
