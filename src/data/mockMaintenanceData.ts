...
export const INITIAL_MACHINES: MachineEquipment[] = [
  // --- OFFSET ---
  {
    ...
    specifications: 'Impresión offset pliegos. Humectación, registro y rodillos dadores de tinta y agua.',
    documents: [
  ...
  },
  {
    ...
    specifications: 'Prensa offset de pliegos y formas continuas de planta Reynosa.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Téc. Héctor Domínguez',
    specifications: 'Prensa rotativa offset para formas y papelería comercial continua.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Ing. Roberto Garza',
    specifications: 'Torre de 8 colores para tirajes combinados y formas especializadas.',
    documents: [
  ...
  // --- FLEXOGRAFÍA ---
  {
    ...
    responsibleTechnician: 'Ing. Roberto Garza',
    specifications: 'Prensa flexográfica rotativa de 7 pulgadas de ancho de banda. Estaciones de tinta y troquelado.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Téc. Héctor Domínguez',
    specifications: 'Prensa flexográfica de 10 pulgadas de ancho de banda. Estaciones de impresión y suajado rotativo.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Ing. Roberto Garza',
    specifications: 'Prensa flexográfica de 7 colores y 10 pulgadas para etiquetas autoadheribles de alta resolución.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Téc. Héctor Domínguez',
    specifications: 'Línea de flexografía para tirajes de etiquetas industriales y conversión continua.',
    documents: [
  ...
  },
  {
    ...
    specifications: 'Rebobinado, corte e inspección óptica de rollos de etiquetas terminados.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Téc. Fernando Lozano',
    specifications: 'Dobladora de bolsas y cuchillas para folletería, instructivos y encartes.',
    documents: [
  ...
  },
  {
    ...
    responsibleTechnician: 'Téc. Fernando Lozano',
    specifications: 'Línea de grapado y acabado a caballo para revistas, catálogos y folletos.',
    documents: [
