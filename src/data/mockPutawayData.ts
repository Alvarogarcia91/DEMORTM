...
export const INITIAL_PUTAWAY_ORDERS: PutawayOrder[] = [
  ...
  // 9. Almacén Auxiliar Reynosa - Completa
  {
    ...
    items: [
      { id: 'oai-9-1', uid: 'TAR-RTM-2026-000151', sku: 'PT-ETQ-001', productName: 'Etiqueta Farmacéutica 4x6" Medifarma', brand: 'Medifarma', size: 'Individual', lotNumber: 'LOTE-2026-W33', sourceLocation: 'REC-REY-AUX', targetLocation: 'SHOW-01', suggestedLocation: 'SHOW-01', status: 'Acomodado', completedAt: '25 Ago 12:30', operator: 'Brenda Cavazos' },
