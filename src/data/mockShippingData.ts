...
export const INITIAL_MOCK_SHIPPING_ORDERS: ShippingOutboundOrder[] = [
  ...
  // =========================================================================
  {
    ...
    stops: [
      ...
      },
      {
        ...
        address: 'Av. Frida Kahlo 195, Parque Industrial Reynosa, Reynosa, Tamps.',
      ...
      },
      {
        ...
        address: 'Av. Eugenio Garza Sada 3820, Col. Contry, Reynosa, Tamps.',
  ...
  // =========================================================================
  // 2. VENTA MULTI-PARADA (2 Entregas · 8 Unidades · Parque Industrial Del Norte & Santa Catarina)
  // =========================================================================
  {
    id: 'sh-ord-2',
    folio: 'OS-2026-0050',
    ...
    stops: [
      {
        ...
        zoneName: 'Parque Industrial Del Norte',
        address: 'Av. Paseo de los Leones 3300, Parque Industrial Del Norte, Reynosa, Tamps.',
    ...
    routeAlternatives: [
      ...
      },
      {
        ...
        totalWindowsCount: 2,
        stopsSequence: ['stop-50-1', 'stop-50-2'],
        description: 'Llegada anticipada a Parque Industrial Del Norte para entrega con cita de obra matutina.',
      },
    ],
  },
  ...
  // =========================================================================
  {
    ...
    originCoordinates: { x: 260, y: 70, name: 'ALM-MP (Materia Prima - Nave 1 Reynosa)' },
    destinationName: 'Empaques Modernos del Norte S.A.',
    destinationAddress: 'Av. Ricardo Margáin 555, Santa Engracia, Reynosa, Tamps.',
    totalUnits: 6,
    remisionFolio: 'REM-2026-0064',
  ...
  // =========================================================================
  {
    ...
    destinationName: 'Schneider Electric México (Planta 3)',
    destinationAddress: 'Av. Eugenio Garza Sada 3820, Col. Contry, Reynosa, Tamps.',
    totalUnits: 3,
  ...
  // =========================================================================
  {
    ...
    destinationFacility: 'Laboratorios Medifarma (Parque Industrial) · Av. Lázaro Cárdenas 2400, Parque Industrial Reynosa, Reynosa, Tamps.',
    totalUnits: 14,
    ...
    stops: [
      {
        ...
        destinationName: 'Laboratorios Medifarma (Parque Industrial)',
        zoneName: 'Parque Industrial Reynosa',
        address: 'Av. Lázaro Cárdenas 2400, Parque Industrial Reynosa, Reynosa, Tamps.',
        coordinates: { x: 440, y: 340 },
        totalUnits: 14,
        remisionFolio: 'REM-TR-2026-0021',
        sourceDocumentFolio: 'OTP-2026-0044',
  ...
  // =========================================================================
  {
    ...
    destinationFacility: 'Delphi Technologies (Parque Villa Florida) · Av. Paseo de los Leones 1200, Parque Industrial Villa Florida, Reynosa, Tamps.',
    totalUnits: 9,
    ...
    assignedLane: 'EMB-03',
    notes: 'Traspaso programado de alta rotación para exhibición en Almacén Planta Matamoros.',
    selectedStrategy: 'DIRECT',
    items: [
      {
        sku: 'CJ-EMB-MED',
    ...
    stops: [
      {
        ...
        address: 'Av. Paseo de los Leones 1200, Parque Industrial Del Norte, Reynosa, Tamps.',
        coordinates: { x: 170, y: 190 },
        totalUnits: 9,
        remisionFolio: 'REM-TR-2026-0022',
        sourceDocumentFolio: 'OTP-2026-0047',
        customerType: 'Instalación Operativa',
        contactName: 'Ing. Jorge Villarreal (Recibo Schneider)',
        timeWindow: '10:30 - 12:00 h',
        priority: 'Normal',
        items: [
          {
    ...
    routeAlternatives: [
      {
        ...
        description: 'Trayecto directo desde Parque Industrial Reynosa a Planta Principal por Av. Industrias.',
      },
    ],
    stops: [
      {
    ...
    loadingZones: [
      {
        ...
        zoneName: 'Parque Industrial Del Norte',
        address: 'Paseo de los Leones 4500, Parque Industrial Del Norte, Reynosa, Tamps.',
      ...
      },
      {
        ...
        zoneName: 'Parque Industrial Villa Florida',
        address: 'Av. Paseo de los Conquistadores 800, Parque Industrial Del Norte, N.L.',
      ...
      },
      {
        ...
        destinationName: 'Empaques Modernos del Norte S.A.',
        zoneName: 'Parque Industrial Villa Florida',
        address: 'Av. Paseo de los Leones 1500, Reynosa, Tamps.',
    ...
    stops: [
      {
        ...
        status: 'Completada',
        completedAt: '11:25',
        statusNotes: 'Unidades descargadas físicamente en andén de Parque Industrial Del Norte. Pendiente de ingreso/recepción en Mesa de Verificación.',
        arrivalRecord: {
    ...
    stops: [
      {
        ...
        priority: 'Alta',
        status: 'En atención',
        statusNotes: 'Llegada registrada a las 12:40 h en andén de recibo de Medifarma.',
        arrivalRecord: {
...
export const INITIAL_MOCK_SHIPPING_HISTORY: ShippingHistoryRecord[] = [
  ...
  // =========================================================================
  {
    ...
    stops: [
      ...
      },
      {
        ...
        address: 'Av. Lázaro Cárdenas 2225, Parque Industrial Reynosa, Reynosa, Tamps.',
        zoneName: 'Parque Industrial Reynosa',
        remisionFolio: 'REM-2026-0063',
        sourceDocumentFolio: 'PED-2026-0098',
        totalUnits: 3,
      ...
      },
      {
        ...
        address: 'Av. Eugenio Garza Sada 4500, Col. Las Brisas, Reynosa, Tamps.',
  ...
  // =========================================================================
  {
    ...
    sourceDocumentType: 'Pedido',
    destinationSummary: 'Schneider Electric de México S.A.',
    vehicleId: 'veh-12',
    vehicleName: 'Camión #12 · Hino 300',
    driverId: 'drv-3',
    driverName: 'Luis Herrera',
    ...
    stops: [
      {
        ...
        address: 'Av. Paseo de los Leones 2800, Parque Industrial Villa Florida, Reynosa, Tamps.',
        zoneName: 'Parque Industrial Villa Florida',
        ...
        coordinates: { lat: 25.7280, lng: -100.4120, label: '25.7280, -100.4120 (Parque Industrial Villa Florida)' },
    ...
    stops: [
      {
        ...
        address: 'Av. Gonzalitos 450, Mitras Sur, Reynosa, Tamps.',
  ...
  // =========================================================================
  // 9. TRASPASO CON RECEPCIÓN CONFIRMADA EN MdeV (Parque Industrial Reynosa)
  // =========================================================================
  {
    id: 'hist-rt-0018',
  ...
  // =========================================================================
  // 10. TRASPASO CON RECEPCIÓN CONFIRMADA EN MdeV (Parque Industrial Del Norte)
  // =========================================================================
  {
    id: 'hist-rt-0021',
...
export const INITIAL_MOCK_ATTENTION_ITEMS: DashboardAttentionItem[] = [
  ...
  },
  {
    ...
    destinationName: 'Schneider Electric de México S.A.',
