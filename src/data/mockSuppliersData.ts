...
export const INITIAL_MOCK_SUPPLIERS: SupplierMaster[] = [
  ...
  // 8. Proveedor Demo BOPP (Caso 4: Condicionado con 2 rechazos por espesor y lote en HOLD)
  {
    id: 'sup-demo-bopp',
    code: 'PROV-RTM-008',
    legalName: 'Polímeros y Películas BOPP de México S.A. de C.V. (Demo)',
    tradeName: 'Proveedor Demo BOPP',
    rfc: 'PBM180422XY0',
    type: 'Nacional',
    status: 'Activo',
    paymentCondition: 'Crédito',
    ...
    commercialNotes: 'Proveedor ficticio configurado para demostración de alertas de calidad y acciones correctivas sin afectar relaciones reales. Suministro de bobinas BOPP para flexo.',
    associatedBrands: ['PolyFilm BOPP', 'DemoFilm'],
    preferredCurrency: 'MXN',
    notes: 'Proveedor en estatus Condicionado por 2 lotes no conformes en los últimos 60 días (espesor fuera de tolerancia).',
    ...
    contacts: [
      {
        ...
        position: 'Jefe de Aseguramiento de Calidad',
        email: 'cmendoza@demobopp-supplier.com',
        phone: '(81) 8900-1122',
        isPrimary: true,
        status: 'Activo',
      },
      {
        id: 'con-bopp-02',
        name: 'Lic. Miriam Soto',
        position: 'Ejecutiva de Cuentas Clave',
        email: 'msoto@demobopp-supplier.com',
        phone: '(81) 8900-1123',
        isPrimary: false,
        status: 'Activo',
      },
    ...
    addresses: [
      {
        id: 'addr-bopp-01',
        type: 'Fiscal',
        street: 'Av. de la Industria Plástica',
        exteriorNumber: '404',
        extNumber: '404',
        neighborhood: 'Parque Industrial Escobedo',
        city: 'General Escobedo',
        state: 'Nuevo León',
        postalCode: '66062',
        country: 'México',
    ...
    articles: [
      {
        id: 'rel-bopp-01',
        articleSku: 'MP-BOP-30M',
        articleName: 'Película BOPP Transparente 30 micras (12” x 3,000 m)',
        brand: 'PolyFilm BOPP',
        size: 'Bobina 3,000 m',
        purchaseUnit: 'bobina',
        supplierSku: 'PF-BOPP-30-12',
        leadTimeDays: 8,
        estimatedLeadDays: 8,
        referencePrice: 5400.00,
        currency: 'MXN',
        minOrderQuantity: 4,
        isPreferred: false,
        status: 'Activo',
      ...
      {
        id: 'rel-bopp-02',
        articleSku: 'MP-BOP-CAV',
        articleName: 'Película BOPP Blanco Cavitado 38 micras (10” x 2,500 m)',
        brand: 'PolyFilm BOPP',
        size: 'Bobina 2,500 m',
        purchaseUnit: 'bobina',
        supplierSku: 'PF-BOPP-CAV-38',
        leadTimeDays: 8,
        estimatedLeadDays: 8,
        referencePrice: 6100.00,
        currency: 'MXN',
        minOrderQuantity: 4,
        isPreferred: false,
        status: 'Activo',
    ...
    documents: [
      {
        id: 'doc-bopp-01',
        name: 'Ficha Técnica BOPP 30 micras',
        type: 'Ficha Técnica',
        fileName: 'FT_PolyFilm_BOPP_30um.pdf',
        fileSizeKb: 340,
        uploadDate: '10 May 2024',
        uploadedAt: '10 May 2024',
        expirationDate: '31 Dic 2026',
        expiresAt: '31 Dic 2026',
        status: 'Vigente',
      },
      {
        ...
        name: 'Constancia de Situación Fiscal 2026',
        type: 'Constancia Fiscal',
        fileName: 'CSF_DemoBOPP_2026.pdf',
        fileSizeKb: 190,
        uploadDate: '15 Ene 2026',
        uploadedAt: '15 Ene 2026',
        expirationDate: '31 Dic 2026',
    ...
    timeline: [
      {
        id: 'tl-bopp-01',
        occurredAt: '05 Sep 2026 · 16:30',
        actor: 'Alicia Ramírez',
        role: 'Aseguramiento de Calidad',
        action: 'Emitió Acción Correctiva ACP-2026-0008 por espesor fuera de tolerancia en lote BOPP-260819-01 (INC-048).',
        type: 'status_changed',
      },
      {
        id: 'tl-bopp-02',
        occurredAt: '22 Ago 2026 · 10:00',
        actor: 'Alicia Ramírez',
        role: 'Calidad Incoming',
        action: 'Registró lote en HOLD (INC-038) por falta de CoA y variación de calibre.',
        type: 'status_changed',
      },
    ],
    priceLists: [],
